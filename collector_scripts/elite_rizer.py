                ...
                if (incline_value < 3000):
                    ...
                    if (incline_value < self.current_incline_on_rizer and self.current_incline_on_rizer > -14):
                        ...
                        #self.current_incline_on_rizer -= 1
                                                         ...
                                                         #read steering over BLE ONLY WORKING with master_collector script!!!
...
#---------------------------BLE functions--------------------------------
    ...
    async def connect_rizer(self): # current
    ...
    async def write_incline(self, up, updateValue = True): # Current
