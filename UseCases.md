...
|  Use Case Number | Description | Scenario | Pedal sensor aka. Direto Trainer | Rocker Plate sensors | Brake sensor | Rizer |
|-----|-----|-----|-----|-----|-----|-----|
...
|  R2d | Getting into the turning lane —> this should be implemented along with R2c imo | 2 | x | x | x |  |
|  R2e | Traffic signs at intersections: Stop, Vorfahrt, Vorfahrt gewähren | 1/2/3 | x (depends on the traffic sign) |  | x (depends on the traffic sign) |  |
...
|  R5d | Braking for an obstacle visible only late because of bad weather conditions (combine with R1f) | 4 |  |  | x |  |
|  R5d | Braking in slippery weather conditions | 4 |  | x | x |  |
|  R5e | Driving at night —> see no difference to R4b | 3 | x |  |  |  |
|  R5f | Driving in the city with poor visibility —> combine with R5b and pretty much any other use case | 3 | x |  |  |  |
|  R5f | Driving in the forest with poor visibility —> combine with R5b | 4 | x |  |  |  |
...
|  A1c | Crossing an intersection with high traffic density and regular road crossing (Zebrastreifen) | 2 | x |  | x |  |
...
|  Use Case Number | Description | Scenario | Pedal sensor aka. Direto Trainer | Rocker Plate sensors | Brake sensor | Rizer |
|-----|-----|-----|-----|-----|-----|-----|
|  A2a | Driving on the road without a bike path with low traffic densityand slow cars | 1 | x |  |  |  |
|  A2a | Driving on the road without a bike path with high traffic density and fast cars | 2 | x |  |  |  |
...
|  Use Case Number | Description | Scenario | Pedal sensor aka. Direto Trainer | Rocker Plate sensors | Brake sensor | Rizer |
|-----|-----|-----|-----|-----|-----|-----|
|  A5a | Driving on a wet road with cars next to it (combine with R5a) | 3 | x |  |  |  |
|  A5b | Driving in rain/fog or poor visibility including car headlights (combine with R5b) | 3 | x |  |  |  |
|  A5c | Driving in snow and slippery conditions, possibly with splashing slush | 3 | x |  |  |  |
|  A5d | Driving in different weather conditions at dusk and at night (combine with A4a, R4b…) | 2 | x |  |  |  |
