...
| R1b             | Turning right                                                               | 2        | x      | x            |       |       |
| R1c             | Raising the left hand to indicate an upcoming turn to the left              | 2        | x      | x            |       |       |
| R1c             | Turning left                                                                | 2        | x      | x            |       |       |
| R1d             | Driving uphill                                                              | 5        | x      |              |       | x     |
| R1d             | Driving downhill                                                            | 5        | x      |              | (x)   | x     |
...
| R2c             | Right turn indication and execution at an intersection            | 2        | x      | x            |       |       |
...
| R4b             | Driving during the night | 4        | x      |              |       |       |

## R5 - Weather influences when cycling

| Use Case Number | Description                                                                 | Scenario | Direto | Rocker Plate | Brake | Rizer |
| --------------- | --------------------------------------------------------------------------- | -------- | ------ | ------------ | ----- | ----- |
| R5a             | Driving on wet road                                                         | -        | x      |              |       |       |
| R5b             | Driving in rain                                                             | -        | x      |              |       |       |
| R5b             | Driving in fog                                                              | 4        | x      |              |       |       |
| R5c             | Driving in snow and slippery conditions                                     | -        | x      | x            |       |       |
| R5c             | Driving in snow and slippery conditions on a bridge                         | -        | x      | x            |       |       |
| R5d             | Braking for an obstacle visible only late because of bad weather conditions | 5        |        |              | x     |       |
| R5d             | Braking in slippery weather conditions                                      | -        |        | x            | x     |       |
| R5e             | Driving at night —> see no difference to R4b                                | 4        | x      |              |       |       |
| R5f             | Driving in the city with poor visibility                                    | 4        | x      |              |       |       |
| R5f             | Driving in the forest with poor visibility                                  | 5        | x      |              |       |       |
...
| A4b             | Driving at night with car headlights behind you or in oncoming traffic | 4        | x      |              |       |       |
...
| Use Case Number | Description                                                            | Scenario | Direto | Rocker Plate | Brake | Rizer |
| --------------- | ---------------------------------------------------------------------- | -------- | ------ | ------------ | ----- | ----- |
| A5a             | Driving on a wet road with cars next to it                             | -        | x      |              |       |       |
| A5b             | Driving in rain/fog or poor visibility including car headlights        | 4        | x      |              |       |       |
| A5c             | Driving in snow and slippery conditions, possibly with splashing slush | -        | x      |              |       |       |
| A5d             | Driving in different weather conditions at dusk and at night           | -        | x      |              |       |       |
